...
function power.steam_engine_horizontal_animation()
return
    {
      layers =
      {
...
function power.steam_engine_vertical_animation()
return
    {
      layers = 
      {
...
{
  {
    ...
    minable = {mining_time = 1, result = "water-turbine"},
    max_health = 500,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
    effectivity = 1,
    fluid_usage_per_tick = 0.5,
    maximum_temperature = 120, --525,
    resistances =
    {
      {
        type = "fire",
    ...
    fluid_box =
    {
      ...
      filter = "pressurized-water",
      minimum_temperature = 120, --485.0
    },
    energy_source =
    {
      type = "electric",
    ...
    horizontal_animation = power.steam_engine_horizontal_animation(),
    vertical_animation = power.steam_engine_vertical_animation(),
    smoke =
    {
      {
        name = "light-smoke",
