...
data:extend(
{
    ...
    results=
    {
	  ...
	  {type="fluid", name="diesel", amount=20, temperature=15},
    },
    ...
    results=
    {
      {type="fluid", name="combustion-mixture", amount=15, temperature=15},
    },
    subgroup = "fluid-recipes",
    crafting_machine_tint =
    {
    ...
    results=
    {
      {type="fluid", name="pressurized-water", amount=10, temperature=15},
    },
    subgroup = "fluid-recipes",
    crafting_machine_tint =
    {
